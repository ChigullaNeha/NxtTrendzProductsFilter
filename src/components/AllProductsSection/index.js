...
class AllProductsSection extends Component {
  ...
  getProducts = async () => {
    ...
    const {activeOptionId, activeCategory, activeRating} = this.state
    console.log(activeRating)
    const apiUrl = `https://apis.ccbp.in/products?sort_by=${activeOptionId}&category=${activeCategory}&rating=${activeRating}`
    const options = {
      headers: {
  ...
  updateActiveRating = activeRating => {
